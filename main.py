...
async def start_method(message: types.Message):
    ...
    await message.answer(text=f"Добро пожаловать в наш супербот по планированию ваших дел. Если вы обмудок, который удалил сообщение со список дел, воспользуйтесь командой /yadebil")
...
@dp.message_handler(commands="yadebil")
